 ...
 *  http://jquery.com
 *
 *  Some modifications by derek.hoy@snowcloud.co.uk
 ...
 $.fn.verticaltabs = function(options) {  
     ...
     return this.each(function() {  
        ...
        function switchContents() {
            ...
            $(".activeContent", verticaltabs).hide().removeClass(".activeContent");   // mod DH to use hide
            $(contents[activeIndex], verticaltabs).fadeIn(options.speed).addClass("activeContent"); // Update content
            setTabsHeight();  // mod DH
        };
        // mod DH
        function setTabsHeight() {  
            tabsHt = $(".verticalslider_tabs", verticaltabs).height();
            $(".verticalslider_contents", verticaltabs).height('auto')
            if (tabsHt > $(".verticalslider_contents", verticaltabs).height()) {
                $(".verticalslider_contents", verticaltabs).height(tabsHt)
            }
        }
