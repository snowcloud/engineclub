...
urlpatterns = patterns('',
    ...
    url(r'^$', 'enginecab.views.users', name='cab'),
    url(r'^alerts/$', 'enginecab.views.alerts', name='cab-alerts'),
    url(r'^reindex/$', 'enginecab.views.reindex', name='cab-reindex'),
    url(r'^resources/$', 'enginecab.views.resources', name='cab-resources'),
    url(r'^users/$', 'enginecab.views.users', name='cab-users'),
