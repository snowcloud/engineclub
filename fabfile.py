...
# THESE ARE UTILITY FUNCTIONS USED IN DEVELOPMENT AND DATA CONVERSION
# THEY ARE LEFT HERE IN CASE THEY ARE USEFUL TO ANYBODY
# BUT THEY WON'T WORK WITH STANDARD REPO.
